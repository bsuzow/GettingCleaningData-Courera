...
The main objective of the project is to learn how to make tidy the data collected in a real world experimentation.  The UCI's "Human Activity Recongination Using Smartphones" dataset is utilized.
